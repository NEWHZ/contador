...
{
    // Seleccionar los espacios de trabajo que estén en estado 'activo' junto con su categoría y límite de tiempo
    $this->db->select('espacios_trabajo.*, categorias.nombre as categoria, categorias.tiempo_limite');
